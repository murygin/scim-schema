...
class UserJsonTest extends Specification {
    ...
    def "should create flat list on json output"() {
        ...
        def builder = new User.Builder("test").setActive(true)
                ...
                .setEmails([new Email.Builder().setValue("moep").build()])
                .setPhoneNumbers([new PhoneNumber.Builder().setValue("moep").build()])
                .setIms([new Ims.Builder().setValue("moep").build()])
                .setGroups([new GroupRef.Builder().setValue("moep").build()])
                .setPhotos([new Photo.Builder().setValue("moep").build()])
                .setLocale("locale")
